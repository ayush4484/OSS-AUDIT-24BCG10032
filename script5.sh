#!/bin/bash
# Script 5: Open Source Manifesto Generator # By: Ayush Raj
...
# Generate manifesto
echo "On $DATE, I use $TOOL because open source means $FREEDOM to me. If I could contribute freely, I would build $BUILD for everyone." > $OUTPUT

# Display result
echo "Manifesto saved to $OUTPUT" cat $OUTPUT
